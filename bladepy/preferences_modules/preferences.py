...
class PreferencesBladePy(QtGui.QDialog, preferencesUI.Ui_PreferencesDialog):
    ...
    def __init__(self, parent=None, OutputViewerWidget=None):
        ...
        try:
            ...
            float(self.list_settings[1].value("default_zoomfactor"))
        ...
        self.ui_preferences_default_color_combo.setCurrentIndex(list(shape_colordictionary.keys()).index(self.default_shape_color))
    ...
    def applyAction(self):
        ...
        if self.first_default:
            self.op_viewer.ui_shape_setcolor_combo.setCurrentIndex(list(shape_colordictionary.keys()).index(self.default_shape_color))
